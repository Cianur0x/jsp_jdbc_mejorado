...
<%
    ...
    try {
        ...
        flagValidaLocalidadBlank = true; // si no sale error pues llegaria hasta aquí
        ...
        if (!flagValidaNumero) {
            ...
            session.setAttribute("error", "Error en campo Estatura");
        } else if (!flagValidaEdad) {
            session.setAttribute("error", "Error en campo Edad");
